# VCS Prys: Virtual Coordinate System付きのイーサリアムクライアントソフトウェア

## 事前準備

Go言語インストール
```
go version go1.22.2 linux/amd64 # 推奨バージョン
```

ドキュメントに従って上のバージョンをインストール
...
```
bazel test //vcs:euclidean_vector_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:utils_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:history_stat_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:coordinate_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:vivaldi_model_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:virtual_coordinate_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:k_means_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:vcs_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:listener_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:client_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:server_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:scheduler_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
bazel test //vcs:lowpass_filter_test --test_arg=-test.v --test_output=streamed --test_arg=-test.failfast --nocache_test_results --test_filter=
```
